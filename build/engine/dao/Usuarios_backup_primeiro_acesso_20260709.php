<?php
    ...
    class Usuarios_backup_primeiro_acesso_20260709 implements \JsonSerializable {
		...
		public function jsonSerialize(): mixed {
			return [
				...
				'roles' =>$this->getRoles(),
				'tema_preferencia' =>$this->getTema_preferencia()
			];
		}
		...
		//TEMA_PREFERENCIA
		function getTema_preferencia() {
			return $this->tema_preferencia;
		}
		function setTema_preferencia($tema_preferencia) {
			return $this->tema_preferencia = $tema_preferencia;
		}
